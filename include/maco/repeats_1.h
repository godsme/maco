...
#else
#include <maco/loop.h>
#define __MACO_simple_repeat_1_core_(next, n, macro) __MACO_while(__MACO_prev(n))(next, (__MACO_prev(n), macro)) macro(n)
#define __MACO_simple_repeat_1_2_(n, macro)          __MACO_simple_repeat_1_core_(__MACO_simple_repeat_1_1_, n, macro)
#define __MACO_simple_repeat_1_1_(n, macro)          __MACO_simple_repeat_1_core_(__MACO_simple_repeat_1_2_, n, macro)
#define __MACO_simple_repeat_from_1(n, macro)        __MACO_loop(n, __MACO_simple_repeat_1_1_(n, macro))
