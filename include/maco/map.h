...
#define __MACO_map_core_(next, f, m, n, x, ...)   f(m, x) __MACO_while(n)(next, (f, __MACO_inc(m), __MACO_dec(n), __VA_ARGS__))
...
#define __MACO_map_(f, n, ...)                    __MACO_loop(n, __MACO_map_1__(f, 0, __MACO_prev(n), __VA_ARGS__))
