...
#define __MACO_iterator_from_1__(n, macro, end_macro) __MACO_iterator_1_##n (macro) __MACO_end_macro_1_##n(end_macro)
#define __MACO_simple_iterator_from_1(n, macro)       __MACO_iterator_from_1__(n, macro, macro)
#else
#include <maco/loop.h>
